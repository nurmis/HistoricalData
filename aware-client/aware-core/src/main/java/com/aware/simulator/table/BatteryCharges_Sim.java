...
public class BatteryCharges_Sim implements AbstractEvent {
    ...
    public BatteryCharges_Sim(int id, long timestamp, UUID device, int batteryStart, int batteryEnd, double doubleEndTimestamp) {
        this._id = id;
