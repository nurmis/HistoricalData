...
public class SensorWifi_Sim implements AbstractEvent {
    ...
    public SensorWifi_Sim(int id, long timestamp, UUID device, String macAdress, String ssid, String bssid) {
        this._id = id;
    ...
    public String toString() {
        return "["+id()+"] - ["+timestamp()+"] - ["+device()+"] - "+ macAddress +" - "+ ssid +" - "+ bssid +"";
    }
}
