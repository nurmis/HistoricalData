...
import com.aware.simulator.noisiness.DataNoiser;
...
public final class AwareSimulator {
    ...
    public final EventsHandler<Accelerometer_Sim> accelerometer;
    public final EventsHandler<ApplicationsForeground_Sim> applicationsForeground;
    public final EventsHandler<Battery_Sim> battery;
    public final EventsHandler<BatteryCharges_Sim> batteryCharges;
    public final EventsHandler<BatteryDischarges_Sim> batteryDischarges;
    public final EventsHandler<Barometer_Sim> barometer;
    public final EventsHandler<Gravity_Sim> gravity;
    public final EventsHandler<Gyroscope_Sim> gyroscope;
    public final EventsHandler<Locations_Sim> locations;
    public final EventsHandler<SensorWifi_Sim> sensorWifi;
    //public final EventsHandler<Wifi_Sim> wifi;
    ...
    public AwareSimulator(final DataSource dataSource, final DataNoiser dataNoiser, final long startTimestamp, final UUID device) {
        ...
        this.accelerometer = new EventsHandler<Accelerometer_Sim>(dataSource.accelerometer(), dataNoiser.accelerometer());
        this.applicationsForeground = new EventsHandler<ApplicationsForeground_Sim>(dataSource.applicationsForeground(), dataNoiser.applicationsForeground());
        this.battery = new EventsHandler<Battery_Sim>(dataSource.battery(), dataNoiser.battery());
        this.batteryCharges = new EventsHandler<BatteryCharges_Sim>(dataSource.batteryCharges(), dataNoiser.batteryCharges());
        this.batteryDischarges = new EventsHandler<BatteryDischarges_Sim>(dataSource.batteryDischarges(), dataNoiser.batteryDischarges());
        this.barometer = new EventsHandler<Barometer_Sim>(dataSource.barometer(), dataNoiser.barometer());
        this.gravity = new EventsHandler<Gravity_Sim>(dataSource.gravity(), dataNoiser.gravity());
        this.gyroscope = new EventsHandler<Gyroscope_Sim>(dataSource.gyroscope(), dataNoiser.gyroscope());
        this.locations = new EventsHandler<Locations_Sim>(dataSource.locations(), dataNoiser.locations());
        this.sensorWifi = new EventsHandler<SensorWifi_Sim>(dataSource.sensorWifi(), dataNoiser.sensorWifi());
        //this.wifi = new EventsHandler<Wifi_Sim>(dataSource.wifi(), dataNoiser.wifi());
